...
public interface BlockingGitterClient {
    /**
     *
    ...
    MessageResponse sendMessage(@Header(HttpHeaders.AUTHORIZATION) String authorization,
     ...
     */
    @Get("/v1/rooms")
    List<Room> findAllRooms(@Header(HttpHeaders.AUTHORIZATION) String authorization);
}
