...
@Property(name = "spec.name", value = "BlockingGitterApiTest")
@MicronautTest(startApplication = false)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class BlockingGitterApiTest implements TestPropertyProvider {
    @Inject
    BlockingGitterApi blockingGitterApi;
    ...
    public String gitterUrl() {
        if (gitterApi == null) {
            gitterApi = ApplicationContext.run(EmbeddedServer.class, Collections.singletonMap("spec.name", "BlockingGitterApiTestGitterApi"));
        }
    ...
    @Requires(property = "spec.name", value = "BlockingGitterApiTestGitterApi")
    @Controller
